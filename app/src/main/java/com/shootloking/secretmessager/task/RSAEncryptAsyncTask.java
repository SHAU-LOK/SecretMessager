 ...
 */
public class RSAEncryptAsyncTask extends AsyncTask<String, Integer, String> {

    private ProgressDialog progressDialog;
    private SMActivity activity;


    public RSAEncryptAsyncTask(SMActivity activity) {
    ...
    protected String doInBackground(String... params) {
        ...
        try {
            ...
            String cipher = RSAEncryptManager.getInstance().encrypt(activity, body);
            long end = System.nanoTime();
            long consume = end - start;
            Debug.log("统计", "RSA加密完成: \n" +
